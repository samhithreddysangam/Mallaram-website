...
export type Dictionary = {
  ...
  nav: { home: string; about: string; dashboard: string; schemes: string; facilities: string; gallery: string; events: string; contact: string; complaint: string; governance: string; villageAdmin: string; prajaTracker: string; school: string };
...
const enDict: Dictionary = {
  ...
  nav: { home: "Home", about: "About", dashboard: "IKP Booking", schemes: "Govt Schemes", facilities: "Facilities", gallery: "Gallery", events: "Events", contact: "Contact", complaint: "Complaint", governance: "Smart Village", villageAdmin: "Village Administration", prajaTracker: "Praja Tracker", school: "School" },
...
const teDict: Dictionary = {
  ...
  nav: { home: "హోమ్", about: "పాలన", dashboard: "IKP బుకింగ్", schemes: "పథకాలు", facilities: "సౌకర్యాలు", gallery: "ఫోటోలు", events: "కార్యక్రమాలు", contact: "సంప్రదింపు", complaint: "ఫిర్యాదు", governance: "స్మార్ట్ విలేజ్", villageAdmin: "గ్రామ పాలన", prajaTracker: "ప్రజా ట్రాకర్", school: "స్కూల్" },
